      ...
      <Container>
        ...
        <div className="flex flex-col items-center border-t border-zinc-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <Link href="#" className="group" aria-label="Clean Subtitle on X">
              <svg
            ...
            <Link href="#" className="group" aria-label="Clean Subtitle on GitHub">
              <svg
          ...
          <p className="mt-6 text-sm text-neutral-500 sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} Clean Subtitle. All rights
            reserved.
          </p>
        </div>
      </Container>
