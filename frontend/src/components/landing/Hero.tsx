...
import logoLaravel from '@/images/landing/logos/laravel.svg'
import logoMirage from '@/images/landing/logos/mirage.svg'
import logoStatamic from '@/images/landing/logos/statamic.svg'
import logoStaticKit from '@/images/landing/logos/statickit.svg'
import logoTransistor from '@/images/landing/logos/transistor.svg'
import logoTuple from '@/images/landing/logos/tuple.svg'
    ...
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        ...
        >
          ...
          <span className="ml-3 dark:text-white text-black">Watch video</span>
        </Button>
      </div>
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-neutral-400">
